...
import com.xutonghuai.latter.net.callback.RequestCallbacks;
import com.xutonghuai.latter.net.download.DownloadHandler;
    ...
    private void request(HttpMethod method){
        ...
        switch (method){
            ...
            case UPLOAD:
                ...
                // MultipartBody.Part  和后端约定好Key，这里的partName是用
        ...
        if(call!=null){
            call.enqueue(getRequestCallback());//异步请求
        }
